...
tapply(data$rating,data$timenum,FUN=var)
...
pairwise.t.test(data$rating, data$timenum,p.adj = "fdr" )
#result: group 4 stands out to be worst than others, 17 to 19

#4. print out the mean for each group to confirm
tapply(data$rating,data$timenum,FUN=mean)